...
#
M_BSZ="96" # takes ~9G VRAM here => reduce this to save VRAM, increase this for faster speed
LR_INIT="6e-4"
LR_FINAL="6e-5"
GRAD_CP=1 # 1 => slower, save VRAM; 0 => faster, more VRAM
EPOCH_SAVE=3 # save every 10 "miniepochs" (1 miniepoch = 40320 * ctx_len tokens) => decrease if your GPU is weak
#
#######################################################################################################################
#
...
#
python train.py --load_model "0" --wandb "RWKV-V7-minipipe-Test" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
